...
namespace Actividad3Prueba.Controllers
{
    public class PaqueteriaController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "id_paqueteria,nombre,telefono,email")] Paqueteria paqueteria)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "id_paqueteria,nombre,telefono,email")] Paqueteria paqueteria)
        {
            if (ModelState.IsValid)
            {
